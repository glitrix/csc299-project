# Task Manager (Markdown/PKM Version)
...
Navigate to the `tasks2` directory and use the following commands:
...
This permanently removes the task and its associated Markdown file from the vault.
...
├── vault/                # Directory containing task Markdown files
│   └── *.md             # Individual task files (e.g., 1-buy-groceries.md)
├── archive_migration/    # Migration utilities (historical)
│   ├── migrate_json_to_md.py
