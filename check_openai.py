...
try:
    ...
    print("[X] python-dotenv is not installed")
    print("  Install with: py -m pip install python-dotenv")
...
try:
    ...
    print("[X] openai package is not installed")
    print("  Install with: py -m pip install openai")
    sys.exit(1)
...
if api_key:
    ...
    try:
        ...
        print(f"[X] API key validation failed: {e}")
